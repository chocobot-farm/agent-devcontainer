...
```bash
gh auth status
./.claude/skills/extract-github-actions-logs/scripts/parse-actions-url.sh --url 'https://github.com/<owner>/<repo>/actions/runs/12345678901' --format command --log
```
...
```bash
./.claude/skills/extract-github-actions-logs/scripts/parse-actions-url.sh --url 'https://github.com/<owner>/<repo>/actions/runs/12345678901/job/23456789012?pr=42'
```
